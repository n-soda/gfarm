...
# installation to non-standard prefix, e.g. /usr/gfarm
#
#   # env QA_RPATHS=3 GFARM_ENABLE_RPATH=true \
#	rpmbuild --define '_prefix /usr/gfarm' -bb gfarm.spec
#

%define globus %(echo "${GFARM_CONFIGURE_OPTION}" | grep -e --with-globus > /dev/null && echo 1 || echo 0)
%define kerberos %(if echo "${GFARM_CONFIGURE_OPTION}" | grep -e --disable-kerberos > /dev/null; then echo 0; elif ls /usr/lib*/libgssapi_krb5.so > /dev/null 2>&1; then echo 1; else echo 0; fi)
...
%if %{gfarm_v2_not_yet}
%{man_prefix}/man1/gfexec.1*
%endif
%{man_prefix}/man1/gfexport.1*
%{man_prefix}/man1/gffindxmlattr.1*
%if %{gfarm_v2_not_yet}
%{man_prefix}/man1/gfgrep.1*
%endif
%{man_prefix}/man1/gfgetfacl.1*
%{man_prefix}/man1/gfgroup.1*
%{man_prefix}/man1/gfhost.1*
%{man_prefix}/man1/gfhostgroup.1*
%if %{gfarm_v2_not_yet}
%{man_prefix}/man1/gfimport_fixed.1*
%{man_prefix}/man1/gfimport_text.1*
%endif
%{man_prefix}/man1/gfjournal.1*
%{man_prefix}/man1/gfjournaladmin.1*
%{man_prefix}/man1/gfkey.1*
%{man_prefix}/man1/gfln.1*
%{man_prefix}/man1/gfls.1*
%{man_prefix}/man1/gflsof.1*
%{man_prefix}/man1/gfmdhost.1*
...
%{man_prefix}/man1/gfrcmd.1*
%endif
%{man_prefix}/man1/gfquota.1*
%{man_prefix}/man1/gfquotacheck.1*
%{man_prefix}/man1/gfreg.1*
%{man_prefix}/man1/gfrep.1*
%{man_prefix}/man1/gfrepcheck.1*
%{man_prefix}/man1/gfrm.1*
%{man_prefix}/man1/gfrmdir.1*
%{man_prefix}/man1/gfsched.1*
%{man_prefix}/man1/gfservice.1*
%{man_prefix}/man1/gfservice-agent.1*
%if %{gfarm_v2_not_yet}
%{man_prefix}/man1/gfront.1*
%{man_prefix}/man1/gfrsh.1*
%{man_prefix}/man1/gfrun.1*
%{man_prefix}/man1/gfsetdir.1*
%{man_prefix}/man1/gfssh.1*
%endif
%{man_prefix}/man1/gfsetfacl.1*
%{man_prefix}/man1/gfspoolpath.1*
%{man_prefix}/man1/gfstat.1*
%{man_prefix}/man1/gfstatus.1*
%{man_prefix}/man1/gfsudo.1*
%{man_prefix}/man1/gftest.1*
%{man_prefix}/man1/gfusage.1*
%{man_prefix}/man1/gfuser.1*
%if %{gfarm_v2_not_yet}
%{man_prefix}/man1/gfwc.1*
%endif
%{man_prefix}/man1/gfwhere.1*
%{man_prefix}/man1/gfwhoami.1*
%{man_prefix}/man1/gfxattr.1*
%{man_prefix}/man1/gfperf-autoreplica.1*
%{man_prefix}/man1/gfperf-copy.1*
%{man_prefix}/man1/gfperf-metadata.1*
%{man_prefix}/man1/gfperf-parallel-autoreplica.1*
%{man_prefix}/man1/gfperf-parallel-read.1*
%{man_prefix}/man1/gfperf-parallel-replica.1*
%{man_prefix}/man1/gfperf-parallel-write.1*
%{man_prefix}/man1/gfperf-read.1*
%{man_prefix}/man1/gfperf-replica.1*
%{man_prefix}/man1/gfperf-tree.1*
%{man_prefix}/man1/gfperf-wrapper.sh.1*
%{man_prefix}/man1/gfperf-write.1*
%{man_prefix}/man1/gfperf.rb.1*
%{man_prefix}/man1/gfstress.rb.1*
%{man_prefix}/man3/gfarm.3*
%{man_prefix}/man3/gfarm_initialize.3*
%{man_prefix}/man3/gfarm_terminate.3*
%{man_prefix}/man3/gfs_acl_add_perm.3*
%{man_prefix}/man3/gfs_acl_calc_mask.3*
%{man_prefix}/man3/gfs_acl_check.3*
%{man_prefix}/man3/gfs_acl_clear_perms.3*
%{man_prefix}/man3/gfs_acl_cmp.3*
%{man_prefix}/man3/gfs_acl_create_entry.3*
%{man_prefix}/man3/gfs_acl_delete_def_file.3*
%{man_prefix}/man3/gfs_acl_delete_entry.3*
%{man_prefix}/man3/gfs_acl_delete_perm.3*
%{man_prefix}/man3/gfs_acl_dup.3*
%{man_prefix}/man3/gfs_acl_entries.3*
%{man_prefix}/man3/gfs_acl_equiv_mode.3*
%{man_prefix}/man3/gfs_acl_error.3*
%{man_prefix}/man3/gfs_acl_free.3*
%{man_prefix}/man3/gfs_acl_from_mode.3*
%{man_prefix}/man3/gfs_acl_from_text.3*
%{man_prefix}/man3/gfs_acl_from_text_with_default.3*
%{man_prefix}/man3/gfs_acl_from_xattr_value.3*
%{man_prefix}/man3/gfs_acl_get_entry.3*
%{man_prefix}/man3/gfs_acl_get_file.3*
%{man_prefix}/man3/gfs_acl_get_perm.3*
%{man_prefix}/man3/gfs_acl_get_permset.3*
%{man_prefix}/man3/gfs_acl_get_qualifier.3*
%{man_prefix}/man3/gfs_acl_get_tag_type.3*
%{man_prefix}/man3/gfs_acl_init.3*
%{man_prefix}/man3/gfs_acl_set_file.3*
%{man_prefix}/man3/gfs_acl_set_permset.3*
%{man_prefix}/man3/gfs_acl_set_qualifier.3*
%{man_prefix}/man3/gfs_acl_set_tag_type.3*
%{man_prefix}/man3/gfs_acl_sort.3*
%{man_prefix}/man3/gfs_acl_to_any_text.3*
%{man_prefix}/man3/gfs_acl_to_text.3*
%{man_prefix}/man3/gfs_acl_to_xattr_value.3*
%{man_prefix}/man3/gfs_acl_valid.3*
%{man_prefix}/man3/gfs_mkdir.3*
%{man_prefix}/man3/gfs_pio_close.3*
%{man_prefix}/man3/gfs_pio_create.3*
%{man_prefix}/man3/gfs_pio_datasync.3*
%{man_prefix}/man3/gfs_pio_flush.3*
%{man_prefix}/man3/gfs_pio_open.3*
%{man_prefix}/man3/gfs_pio_read.3*
%{man_prefix}/man3/gfs_pio_write.3*
%{man_prefix}/man3/gfs_pio_recvfile.3*
%{man_prefix}/man3/gfs_pio_seek.3*
%{man_prefix}/man3/gfs_pio_sendfile.3*
%{man_prefix}/man3/gfs_pio_sync.3*
%{man_prefix}/man3/gfs_stat.3*
%{man_prefix}/man3/gfs_stat_free.3*
%{man_prefix}/man3/gfs_rmdir.3*
%{man_prefix}/man3/gfs_unlink.3*
%if %{gfarm_v2_not_yet}
%{man_prefix}/man3/gfarm_strings_free_deeply.3*
%{man_prefix}/man3/gfarm_url_fragments_replicate.3*
%{man_prefix}/man3/gfarm_url_hosts_schedule.3*
%{man_prefix}/man3/gfarm_url_section_replicate_from_to.3*
%{man_prefix}/man3/gfarm_url_section_replicate_to.3*
%{man_prefix}/man3/gfs_chdir.3*
%{man_prefix}/man3/gfs_chmod.3*
%{man_prefix}/man3/gfs_closedir.3*
%{man_prefix}/man3/gfs_glob.3*
%{man_prefix}/man3/gfs_glob_add.3*
%{man_prefix}/man3/gfs_glob_free.3*
%{man_prefix}/man3/gfs_glob_init.3*
%{man_prefix}/man3/gfs_opendir.3*
%{man_prefix}/man3/gfs_pio_eof.3*
%{man_prefix}/man3/gfs_pio_error.3*
%{man_prefix}/man3/gfs_pio_getc.3*
%{man_prefix}/man3/gfs_pio_getline.3*
%{man_prefix}/man3/gfs_pio_gets.3*
%{man_prefix}/man3/gfs_pio_putc.3*
%{man_prefix}/man3/gfs_pio_putline.3*
%{man_prefix}/man3/gfs_pio_puts.3*
%{man_prefix}/man3/gfs_pio_readdelim.3*
%{man_prefix}/man3/gfs_pio_readline.3*
%{man_prefix}/man3/gfs_pio_set_local.3*
%{man_prefix}/man3/gfs_pio_set_view_index.3*
%{man_prefix}/man3/gfs_pio_set_view_local.3*
%{man_prefix}/man3/gfs_pio_truncate.3*
%{man_prefix}/man3/gfs_pio_ungetc.3*
%{man_prefix}/man3/gfs_readdir.3*
%{man_prefix}/man3/gfs_realpath.3*
%{man_prefix}/man3/gfs_rename.3*
%{man_prefix}/man3/gfs_unlink_section.3*
%{man_prefix}/man3/gfs_utimes.3*
%endif
%{man_prefix}/man5/gfarm2.conf.5*
%{man_prefix}/man5/gfarm_attr.5*
%{man_prefix}/man5/gfservice.conf.5*
...
%if %{gfarm_v2_not_yet}
%{man_prefix}/ja/man1/gfexec.1*
%endif
%{man_prefix}/ja/man1/gfexport.1*
%{man_prefix}/ja/man1/gffindxmlattr.1*
%if %{gfarm_v2_not_yet}
%{man_prefix}/ja/man1/gfgrep.1*
%endif
%{man_prefix}/ja/man1/gfgetfacl.1*
%{man_prefix}/ja/man1/gfgroup.1*
%{man_prefix}/ja/man1/gfhost.1*
%{man_prefix}/ja/man1/gfhostgroup.1*
%if %{gfarm_v2_not_yet}
%{man_prefix}/ja/man1/gfimport_fixed.1*
%{man_prefix}/ja/man1/gfimport_text.1*
%endif
%{man_prefix}/ja/man1/gfjournal.1*
%{man_prefix}/ja/man1/gfjournaladmin.1*
%{man_prefix}/ja/man1/gfkey.1*
%{man_prefix}/ja/man1/gfln.1*
%{man_prefix}/ja/man1/gfls.1*
%{man_prefix}/ja/man1/gflsof.1*
%{man_prefix}/ja/man1/gfmdhost.1*
...
%{man_prefix}/ja/man1/gfrcmd.1*
%endif
%{man_prefix}/ja/man1/gfquota.1*
%{man_prefix}/ja/man1/gfquotacheck.1*
%{man_prefix}/ja/man1/gfreg.1*
%{man_prefix}/ja/man1/gfrep.1*
%{man_prefix}/ja/man1/gfrepcheck.1*
%{man_prefix}/ja/man1/gfrm.1*
%{man_prefix}/ja/man1/gfrmdir.1*
%{man_prefix}/ja/man1/gfsched.1*
%{man_prefix}/ja/man1/gfservice.1*
%{man_prefix}/ja/man1/gfservice-agent.1*
%if %{gfarm_v2_not_yet}
%{man_prefix}/ja/man1/gfront.1*
%{man_prefix}/ja/man1/gfrsh.1*
%{man_prefix}/ja/man1/gfrun.1*
%{man_prefix}/ja/man1/gfsetdir.1*
%{man_prefix}/ja/man1/gfssh.1*
%endif
%{man_prefix}/ja/man1/gfsetfacl.1*
%{man_prefix}/ja/man1/gfspoolpath.1*
%{man_prefix}/ja/man1/gfstat.1*
%{man_prefix}/ja/man1/gfstatus.1*
%{man_prefix}/ja/man1/gfsudo.1*
%{man_prefix}/ja/man1/gftest.1*
%{man_prefix}/ja/man1/gfusage.1*
%{man_prefix}/ja/man1/gfuser.1*
%if %{gfarm_v2_not_yet}
%{man_prefix}/ja/man1/gfwc.1*
%endif
%{man_prefix}/ja/man1/gfwhere.1*
%{man_prefix}/ja/man1/gfwhoami.1*
%{man_prefix}/ja/man1/gfxattr.1*
%{man_prefix}/ja/man1/gfperf-autoreplica.1*
%{man_prefix}/ja/man1/gfperf-copy.1*
%{man_prefix}/ja/man1/gfperf-metadata.1*
%{man_prefix}/ja/man1/gfperf-parallel-autoreplica.1*
%{man_prefix}/ja/man1/gfperf-parallel-read.1*
%{man_prefix}/ja/man1/gfperf-parallel-replica.1*
%{man_prefix}/ja/man1/gfperf-parallel-write.1*
%{man_prefix}/ja/man1/gfperf-read.1*
%{man_prefix}/ja/man1/gfperf-replica.1*
%{man_prefix}/ja/man1/gfperf-tree.1*
%{man_prefix}/ja/man1/gfperf-wrapper.sh.1*
%{man_prefix}/ja/man1/gfperf-write.1*
%{man_prefix}/ja/man1/gfperf.rb.1*
%{man_prefix}/ja/man1/gfstress.rb.1*
%{man_prefix}/ja/man3/gfarm.3*
%{man_prefix}/ja/man3/gfarm_initialize.3*
%{man_prefix}/ja/man3/gfarm_terminate.3*
%{man_prefix}/ja/man3/gfs_mkdir.3*
%{man_prefix}/ja/man3/gfs_pio_close.3*
%{man_prefix}/ja/man3/gfs_pio_create.3*
%{man_prefix}/ja/man3/gfs_pio_datasync.3*
%{man_prefix}/ja/man3/gfs_pio_flush.3*
%{man_prefix}/ja/man3/gfs_pio_open.3*
%{man_prefix}/ja/man3/gfs_pio_read.3*
%{man_prefix}/ja/man3/gfs_pio_write.3*
%{man_prefix}/ja/man3/gfs_pio_recvfile.3*
%{man_prefix}/ja/man3/gfs_pio_seek.3*
%{man_prefix}/ja/man3/gfs_pio_sendfile.3*
%{man_prefix}/ja/man3/gfs_pio_sync.3*
%{man_prefix}/ja/man3/gfs_stat.3*
%{man_prefix}/ja/man3/gfs_stat_free.3*
%{man_prefix}/ja/man3/gfs_rmdir.3*
%{man_prefix}/ja/man3/gfs_unlink.3*
%if %{gfarm_v2_not_yet}
%{man_prefix}/ja/man3/gfarm_hostlist_read.3*
%{man_prefix}/ja/man3/gfarm_import_fragment_config_read.3*
%{man_prefix}/ja/man3/gfarm_import_fragment_size_alloc.3*
%{man_prefix}/ja/man3/gfarm_stringlist_add.3*
%{man_prefix}/ja/man3/gfarm_stringlist_cat.3*
%{man_prefix}/ja/man3/gfarm_stringlist_elem.3*
%{man_prefix}/ja/man3/gfarm_stringlist_free.3*
%{man_prefix}/ja/man3/gfarm_stringlist_init.3*
%{man_prefix}/ja/man3/gfarm_stringlist_length.3*
%{man_prefix}/ja/man3/gfarm_strings_free_deeply.3*
%{man_prefix}/ja/man3/gfarm_url_fragments_replicate.3*
%{man_prefix}/ja/man3/gfarm_url_hosts_schedule.3*
%{man_prefix}/ja/man3/gfarm_url_program_deliver.3*
%{man_prefix}/ja/man3/gfarm_url_program_register.3*
%{man_prefix}/ja/man3/gfarm_url_section_replicate_from_to.3*
%{man_prefix}/ja/man3/gfarm_url_section_replicate_to.3*
%{man_prefix}/ja/man3/gfs_chdir.3*
%{man_prefix}/ja/man3/gfs_chmod.3*
%{man_prefix}/ja/man3/gfs_closedir.3*
%{man_prefix}/ja/man3/gfs_glob.3*
%{man_prefix}/ja/man3/gfs_glob_add.3*
%{man_prefix}/ja/man3/gfs_glob_free.3*
%{man_prefix}/ja/man3/gfs_glob_init.3*
%{man_prefix}/ja/man3/gfs_opendir.3*
%{man_prefix}/ja/man3/gfs_pio_eof.3*
%{man_prefix}/ja/man3/gfs_pio_error.3*
%{man_prefix}/ja/man3/gfs_pio_getc.3*
%{man_prefix}/ja/man3/gfs_pio_getline.3*
%{man_prefix}/ja/man3/gfs_pio_gets.3*
%{man_prefix}/ja/man3/gfs_pio_putc.3*
%{man_prefix}/ja/man3/gfs_pio_putline.3*
%{man_prefix}/ja/man3/gfs_pio_puts.3*
%{man_prefix}/ja/man3/gfs_pio_readdelim.3*
%{man_prefix}/ja/man3/gfs_pio_readline.3*
%{man_prefix}/ja/man3/gfs_pio_set_local.3*
%{man_prefix}/ja/man3/gfs_pio_set_view_index.3*
%{man_prefix}/ja/man3/gfs_pio_set_view_local.3*
%{man_prefix}/ja/man3/gfs_pio_truncate.3*
%{man_prefix}/ja/man3/gfs_pio_ungetc.3*
%{man_prefix}/ja/man3/gfs_readdir.3*
%{man_prefix}/ja/man3/gfs_realpath.3*
%{man_prefix}/ja/man3/gfs_rename.3*
%{man_prefix}/ja/man3/gfs_unlink_section.3*
%{man_prefix}/ja/man3/gfs_utimes.3*
%endif
%{man_prefix}/ja/man5/gfarm2.conf.5*
%{man_prefix}/ja/man5/gfarm_attr.5*
%{man_prefix}/ja/man5/gfservice.conf.5*
...
%{man_prefix}/ja/man8/config-gfsd.8*
