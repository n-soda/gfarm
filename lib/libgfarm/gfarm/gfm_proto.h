...
#define GFM_PROTOCOL_VERSION_V2_5_0	1
#define GFM_PROTOCOL_VERSION_V2_5_1	2
#define GFM_PROTOCOL_VERSION_V2_5_2	3
#define GFM_PROTOCOL_VERSION_V2_5_5	4
#define GFM_PROTOCOL_VERSION_V2_5_6	5
#define GFM_PROTOCOL_VERSION_V2_5_8	6
#define GFM_PROTOCOL_VERSION_V2_5_8_5	7
#define GFM_PROTOCOL_VERSION_V2_5_8_7	8
#define GFM_PROTOCOL_VERSION_V2_6_0	9
#define GFM_PROTOCOL_VERSION_V2_6_1	10
#define GFM_PROTOCOL_VERSION_V2_6_5	11
#define GFM_PROTOCOL_VERSION_V2_6_6	12
#define GFM_PROTOCOL_VERSION_V2_6_8	13
#define GFM_PROTOCOL_VERSION_V2_6_9	14
#define GFM_PROTOCOL_VERSION_V2_6_14	15
#define GFM_PROTOCOL_VERSION_V2_6_22	16
#define GFM_PROTOCOL_VERSION_V2_7_0	17
#define GFM_PROTOCOL_VERSION_V2_7_6	18
#define GFM_PROTOCOL_VERSION_V2_7_7	19
#define GFM_PROTOCOL_VERSION_V2_7_13	20
#define GFM_PROTOCOL_VERSION_V2_8_0	21

#define GFM_PROTOCOL_VERSION		GFM_PROTOCOL_VERSION_V2_8_0

#define GFM_INTER_GFMD_PROTOCOL_VERSION	GFM_PROTOCOL_VERSION_V2_5_0
...
enum gfm_proto_command {
	...
	GFM_PROTO_FSNGROUP_GET_ALL,		/* since gfarm-2.6.0 */
	GFM_PROTO_FSNGROUP_GET_BY_HOSTNAME,	/* since gfarm-2.6.0 */
	GFM_PROTO_FSNGROUP_MODIFY,		/* since gfarm-2.6.0 */
	...
	GFM_PROTO_USER_INFO_GET_MY_OWN,		/* since gfarm-2.8.0 */
	GFM_PROTO_USER_INFO_GET_BY_AUTH_ID,	/* since gfarm-2.8.0 */
	GFM_PROTO_USER_AUTH_GET,		/* since gfarm-2.8.0 */
	GFM_PROTO_USER_AUTH_MODIFY,		/* since gfarm-2.8.0 */
	...
	GFM_PROTO_DIRSET_INFO_SET,		/* since gfarm-2.7.0 */
	GFM_PROTO_DIRSET_INFO_REMOVE,		/* since gfarm-2.7.0 */
	GFM_PROTO_DIRSET_INFO_LIST,		/* since gfarm-2.7.0 */
	GFM_PROTO_QUOTA_DIRSET_GET,		/* since gfarm-2.7.0 */
	GFM_PROTO_QUOTA_DIRSET_SET,		/* since gfarm-2.7.0 */
	GFM_PROTO_QUOTA_DIR_GET,		/* since gfarm-2.7.0 */
	GFM_PROTO_QUOTA_DIR_SET,		/* since gfarm-2.7.0 */
	GFM_PROTO_DIRSET_DIR_LIST,		/* since gfarm-2.7.0 */
	...
	GFM_PROTO_REVOKE_GFSD_ACCESS,		/* since gfarm-2.5.0 */
	GFM_PROTO_FHOPEN,			/* since gfarm-2.5.8.5 */
	GFM_PROTO_CLOSE_GETGEN,			/* since gfarm-2.7.0 */
	...
	GFM_PROTO_FGETATTRPLUS,			/* since gfarm-2.4.1 */
	...
	GFM_PROTO_GETDIRENTSPLUSXATTR,		/* since gfarm-2.4.1 */
	...
	GFM_PROTO_SWITCH_ASYNC_BACK_CHANNEL,	/* since gfarm-2.4.0 */
	GFM_PROTO_CLOSE_WRITE_V2_4,		/* since gfarm-2.4.0 */
	GFM_PROTO_GENERATION_UPDATED,		/* since gfarm-2.4.0 */
	GFM_PROTO_FHCLOSE_READ,			/* since gfarm-2.5.2 */
	GFM_PROTO_FHCLOSE_WRITE,		/* since gfarm-2.5.2 */
	GFM_PROTO_GENERATION_UPDATED_BY_COOKIE,	/* since gfarm-2.5.2 */
	...
	GFM_PROTO_CLOSE_WRITE_V2_8,		/* since gfarm-2.8.0 */
	GFM_PROTO_GENERATION_UPDATED_V2_8,	/* since gfarm-2.8.0 */
	GFM_PROTO_FHCLOSE_WRITE_V2_8,		/* since gfarm-2.8.0 */
	GFM_PROTO_GENERATION_UPDATED_BY_COOKIE_V2_8, /* since gfarm-2.8.0 */
	...
	GFM_PROTO_REPLICA_INFO_GET,		/* since gfarm-2.4.0 */
	GFM_PROTO_REPLICATE_FILE_FROM_TO,	/* since gfarm-2.4.0 */
	GFM_PROTO_REPLICATE_FILE_TO,		/* not used */
	GFM_PROTO_REPLICA_CHECK_CTRL,		/* since gfarm-2.5.8.5 */
	GFM_PROTO_REPLICA_CHECK_STATUS,		/* since gfarm-2.6.22/2.7.7 */
	...
	GFM_PROTO_REPLICATION_RESULT,		/* since gfarm-2.4.0 */
	GFM_PROTO_REPLICA_GET_MY_ENTRIES,	/* since gfarm-2.5.6 */
	GFM_PROTO_REPLICA_CREATE_FILE_IN_LOST_FOUND, /* since gfarm-2.5.6 */
	GFM_PROTO_REPLICA_GET_MY_ENTRIES2,	/* since gfarm-2.5.8 */
	...
	GFM_PROTO_REPLICA_GET_MY_ENTRIES_RANGE,	/* since gfarm-2.6.22/2.7.6 */
	...
	GFM_PROTO_PROCESS_FD_REMOVE,		/* since gfarm-2.8.6 */
	...
	GFM_PROTO_SWITCH_GFMD_CHANNEL,		/* since gfarm-2.5.0 */
	GFM_PROTO_JOURNAL_READY_TO_RECV,	/* since gfarm-2.5.0 */
	GFM_PROTO_JOURNAL_SEND,			/* since gfarm-2.5.0 */
	...
	/* metadb_server */
	GFM_PROTO_METADB_SERVER_GET,		/* since gfarm-2.5.0 */
	GFM_PROTO_METADB_SERVER_GET_ALL,	/* since gfarm-2.5.0 */
	GFM_PROTO_METADB_SERVER_SET,		/* since gfarm-2.5.0 */
	GFM_PROTO_METADB_SERVER_MODIFY,		/* since gfarm-2.5.0 */
	GFM_PROTO_METADB_SERVER_REMOVE,		/* since gfarm-2.5.0 */
...
#define GFM_PROTO_PROCESS_KEY_LEN_MAX		64
...
/* GFM_PROTO_REPLICA_CHECK_STATUS request */
#define GFM_PROTO_REPLICA_CHECK_STATUS_MAINCTRL			0
#define GFM_PROTO_REPLICA_CHECK_STATUS_REMOVE			1
#define GFM_PROTO_REPLICA_CHECK_STATUS_REDUCED_LOG		2

/* GFM_PROTO_REPLICA_CHECK_STATUS result */
#define GFM_PROTO_REPLICA_CHECK_STATUS_ENABLE			0
#define GFM_PROTO_REPLICA_CHECK_STATUS_DISABLE			1
#define GFM_PROTO_REPLICA_CHECK_STATUS_ENABLE_RUNNING		2
#define GFM_PROTO_REPLICA_CHECK_STATUS_ENABLE_STOPPED		3
#define GFM_PROTO_REPLICA_CHECK_STATUS_DISABLE_RUNNING		4
#define GFM_PROTO_REPLICA_CHECK_STATUS_DISABLE_STOPPED		5
...
/* auth_user_id_type Strings */
#define GFARM_AUTH_USER_ID_TYPE_X509 "X509"
#define GFARM_AUTH_USER_ID_TYPE_KERBEROS "Kerberos"
#define GFARM_AUTH_USER_ID_TYPE_SASL "SASL"
