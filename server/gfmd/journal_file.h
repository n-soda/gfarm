...
enum journal_operation {
	...
	GFM_JOURNAL_USER_AUTH_ADD,
	GFM_JOURNAL_USER_AUTH_MODIFY,
	GFM_JOURNAL_USER_AUTH_REMOVE,

	GFM_JOURNAL_PROCESS_ALLOC,
	GFM_JOURNAL_PROCESS_FREE,

	GFM_JOURNAL_SPOOL_OPENED,
	GFM_JOURNAL_SPOOL_CLOSED,
